...
#
# gen_data = datagen.flow_from_directory(path,batch_size=1,shuffle=False,save_to_dir=gen_path+'5',save_prefix='gen',target_size=(224,224))
#
# for i in range(9):
#     gen_data.next()
#
...
# gen_data = datagen.flow_from_directory(path,batch_size=1,shuffle=False,save_to_dir=gen_path+'6',save_prefix='gen',target_size=(224,224))
#
# for i in range(9):
#     gen_data.next()
#
...
#
# gen_data = datagen.flow_from_directory(path,batch_size=1,shuffle=False,save_to_dir=gen_path+'7',save_prefix='gen',target_size=(224,224))
#
# for i in range(9):
#     gen_data.next()
#
...
#
# gen_data = datagen.flow_from_directory(path,batch_size=1,shuffle=False,save_to_dir=gen_path+'8',save_prefix='gen',target_size=(224,224))
#
# for i in range(9):
#     gen_data.next()
#
...
# datagen = image.ImageDataGenerator()
#
# gen_data = datagen.flow_from_directory(path,batch_size=1,shuffle=False,save_to_dir=gen_path + '9',save_prefix='gen',target_size=(224,224))
#
# for i in range(9):
#     gen_data.next()
#
...
#
# gen_data = datagen.flow_from_directory(path,batch_size=1,shuffle=False,save_to_dir=gen_path+'10',save_prefix='gen',target_size=(224,224))
#
# for i in range(9):
#     gen_data.next()
#
...
gen_data = datagen.flow_from_directory(path,batch_size=1,shuffle=False,save_to_dir=gen_path+'11',save_prefix='gen',target_size=(224,224))
